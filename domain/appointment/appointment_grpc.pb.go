...
type AppointmentServiceClient interface {
	List(ctx context.Context, in *AppointmentProto, opts ...grpc.CallOption) (*AppointmentListProto, error)
...
func (c *appointmentServiceClient) List(ctx context.Context, in *AppointmentProto, opts ...grpc.CallOption) (*AppointmentListProto, error) {
...
type AppointmentServiceServer interface {
	List(context.Context, *AppointmentProto) (*AppointmentListProto, error)
...
func (UnimplementedAppointmentServiceServer) List(context.Context, *AppointmentProto) (*AppointmentListProto, error) {
...
func _AppointmentService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppointmentServiceServer).List(ctx, req.(*AppointmentProto))
	}
