...
const (
	Paramedic_CreateParamedic_FullMethodName = "/paramedics.Paramedic/CreateParamedic"
	Paramedic_FindByHospital_FullMethodName  = "/paramedics.Paramedic/FindByHospital"
)
...
type ParamedicClient interface {
	CreateParamedic(ctx context.Context, in *ParamedicCreateProto, opts ...grpc.CallOption) (*emptypb.Empty, error)
	FindByHospital(ctx context.Context, in *ParamedicFindByHospitalProto, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *paramedicClient) CreateParamedic(ctx context.Context, in *ParamedicCreateProto, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Paramedic_CreateParamedic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paramedicClient) FindByHospital(ctx context.Context, in *ParamedicFindByHospitalProto, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Paramedic_FindByHospital_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParamedicServer interface {
	CreateParamedic(context.Context, *ParamedicCreateProto) (*emptypb.Empty, error)
	FindByHospital(context.Context, *ParamedicFindByHospitalProto) (*emptypb.Empty, error)
...
func (UnimplementedParamedicServer) CreateParamedic(context.Context, *ParamedicCreateProto) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateParamedic not implemented")
}
func (UnimplementedParamedicServer) FindByHospital(context.Context, *ParamedicFindByHospitalProto) (*emptypb.Empty, error) {
...
func _Paramedic_CreateParamedic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Paramedic_CreateParamedic_FullMethodName,
	}
...
func _Paramedic_FindByHospital_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Paramedic_FindByHospital_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
